...
urlpatterns = [
    ...
    path('api/sendgrid-sandbox-status/', views.get_sendgrid_sandbox_status_view, name='get_sendgrid_sandbox_status'),
    path('api/toggle-sendgrid-sandbox/', views.toggle_sendgrid_sandbox_view, name='toggle_sendgrid_sandbox'),
    path('api/sandbox-test-email/', views.get_sandbox_test_email_view, name='get_sandbox_test_email'),
    path('api/save-sandbox-test-email/', views.save_sandbox_test_email_view, name='save_sandbox_test_email'),
