...
urlpatterns = [
    ...
    path('teams/<str:team_secret>/roster/<int:roster_id>/previous-games/', views.get_previous_games, name='get_previous_games'),
    path('teams/<str:team_secret>/roster/<int:roster_id>/copy-roster/', views.copy_roster, name='copy_roster'),
