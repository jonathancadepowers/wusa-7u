    ...
    checklist_items = [
        {
            ...
            'validation_description': 'At least 10 players exist in the database',
        ...
        },
        {
            ...
            'validation_description': 'At least 5 teams exist in the database',
            'link': '/teams/',
        ...
        },
        {
            ...
            'validation_description': 'Manager count equals team count AND all managers have a daughter assigned',
            'link': '/managers/',
        ...
        },
        {
            ...
            'validation_description': 'Every manager has submitted team preferences (ranking all teams) OR all managers have been assigned to teams',
        ...
        },
        {
            ...
            'validation_description': 'All teams have a manager assigned AND manager count equals teams with managers',
        ...
        },
        {
            ...
            'validation_description': 'All managers have submitted player rankings (PlayerRanking record exists for each manager)',
        ...
        },
        {
            ...
            'validation_description': 'All managers have submitted manager daughter rankings (ManagerDaughterRanking record exists for each manager)',
        ...
        },
        {
            ...
            'validation_description': 'All teams have been assigned a practice slot (practice_slot field is not null)',
        ...
        },
        {
            ...
            'validation_description': 'Draft exists with rounds > 0, picks_per_round > 0, valid draft order format, and number of teams in draft order equals picks_per_round',
            'link': '/draft/edit/',
        ...
        },
        {
            ...
            'validation_description': 'At least one player exists AND all players have been assigned to a team (team field is not null)',
            'link': '/draft/run/',
